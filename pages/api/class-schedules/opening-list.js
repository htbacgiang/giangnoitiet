        ...
        schedulesWithSessions.forEach(schedule => {
          ...
          if (firstSession) {
            const openingSessionData = {
              ...
              schedule: `${firstSession.dayOfWeek}, ${firstSession.startTime} - ${firstSession.endTime}`,
          ...
          if (firstSession) {
            ...
            if (sessionDate >= startDate && sessionDate <= endDate) {
              const openingSessionData = {
                ...
                schedule: `${firstSession.dayOfWeek}, ${firstSession.startTime} - ${firstSession.endTime}`,
                title: `${schedule.className} - Khai giảng`,
                startDate: new Date(firstSession.date), // For compatibility with existing code
                endDate: schedule.endDate,
                availableSpots: schedule.maxStudents - schedule.currentStudents,
                discountPercentage: schedule.discountPrice && schedule.price 

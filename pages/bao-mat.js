        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-emerald-600 text-lg mb-2">
              Cam kết bảo vệ thông tin cá nhân và dữ liệu sức khỏe tiểu đường thai kỳ
            </p>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-emerald-100 mb-8">
            ...
            <div className="space-y-6 text-sm text-gray-700">
              <div>
                ...
                <p>Chúng tôi chỉ thu thập thông tin cần thiết để cung cấp dịch vụ tư vấn tiểu đường thai kỳ, bao gồm:</p>
                <ul className="ml-4 mt-2 space-y-1">
                  <li>• Thông tin cá nhân cơ bản (tên, email, số điện thoại)</li>
                  <li>• Dữ liệu sức khỏe (chỉ số đường huyết, tuần thai, ghi chú y tế)</li>
              ...
              <div>
                ...
                <ul className="ml-4 mt-2 space-y-1">
                  <li>• Cung cấp dịch vụ tư vấn tiểu đường thai kỳ</li>
                  <li>• Phân tích và đưa ra lời khuyên sức khỏe chuyên môn</li>
          ...
          <div className="text-center">
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-emerald-100">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="mailto:privacy@giangnoitiet.vn">
              ...
              <div className="mt-6 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                <p className="text-sm text-emerald-800">
                  🔒 <strong>Cam kết:</strong> Chúng tôi cam kết bảo vệ thông tin cá nhân và dữ liệu sức khỏe tiểu đường thai kỳ của bạn với mức độ bảo mật cao nhất, tuân thủ đầy đủ các quy định pháp luật về bảo vệ dữ liệu cá nhân.
                </p>
              </div>
            </div>
          </div>

...
export default function StudentManagement() {
  ...
  const handleDeleteClick = (studentId) => {
    ...
    if (confirm(`Bạn có chắc chắn muốn xóa học viên "${student?.fullName || 'này'}"?\n\nHành động này không thể hoàn tác!`)) {
      handleDeleteConfirm(studentId);
    }
  };
  ...
  return (
    <AdminLayout>
      <Head>
        <title>Quản lý học viên - BT Academy</title>
        <meta name="description" content="Quản lý thông tin học viên" />
      </Head>

  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!formData.duration) {
        addError('Thời lượng khóa học là bắt buộc');
        setIsSubmitting(false);
        return;
      }
      ...
      if (formData.sessions < 1) {
        addError('Số buổi học phải lớn hơn 0');
        setIsSubmitting(false);
        return;
      }
          ...
          <form onSubmit={handleSubmit} className="product-form">
            ...
            <div className="form-section">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="form-group">
                  <label className="form-label required" htmlFor="duration">
                    Thời lượng
                  </label>
                  <input
                    id="duration"
                    ...
                    className={`form-input ${errors.some((e) => e.includes('Thời lượng')) ? 'error' : ''}`}
                    required
                    placeholder="Ví dụ: 20 tiếng"
                    aria-label="Thời lượng khóa học"
                    aria-describedby={errors.some((e) => e.includes('Thời lượng')) ? 'error-duration' : undefined}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`form-input ${errors.some((e) => e.includes('Địa điểm')) ? 'error' : ''}`}
                    required
                    placeholder="Địa chỉ trường học"
                    aria-label="Địa điểm"
                    aria-describedby={errors.some((e) => e.includes('Địa điểm')) ? 'error-location' : undefined}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="form-section">
              <div className="flex justify-between items-center mb-4">
                <h3 className="form-section-title mb-0">❓ Câu hỏi thường gặp (FAQ)</h3>

        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-700 to-emerald-900 bg-clip-text text-transparent mb-3">
              👩‍⚕️ Tư vấn chuyên gia tiểu đường thai kỳ
            </h1>
            <p className="text-emerald-600 text-lg mb-2">
              Đồng hành cùng phụ nữ có thai trước, trong và sau khi sinh
            </p>
            <p className="text-gray-500 text-sm">
              Chuyên gia nội tiết giàu kinh nghiệm, hỗ trợ 24/7
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-emerald-100">
              ...
              <p className="text-gray-600 mb-4">
                Tư vấn 1-1 với bác sĩ nội tiết chuyên khoa tiểu đường thai kỳ
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
                <li>• Tư vấn video call trực tiếp</li>
                <li>• Chat hỗ trợ 24/7</li>
                <li>• Đánh giá nguy cơ tiểu đường thai kỳ</li>
                <li>• Kế hoạch quản lý đường huyết cá nhân hóa</li>
              </ul>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-emerald-100">
              ...
              <p className="text-gray-600 mb-4">
                Hỗ trợ phụ nữ có thai trong suốt hành trình trước, trong và sau sinh
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
                <li>• Tư vấn trước khi mang thai</li>
                <li>• Quản lý tiểu đường thai kỳ</li>
                <li>• Hỗ trợ sau sinh và cho con bú</li>
                <li>• Theo dõi sức khỏe lâu dài</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-emerald-100 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-emerald-800 mb-2">Điện thoại</h4>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">info@giangnoitiet.vn</p>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-emerald-800 mb-2">Địa chỉ</h4>
          ...
          <div className="text-center">
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-emerald-100">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="mailto:info@giangnoitiet.vn">
